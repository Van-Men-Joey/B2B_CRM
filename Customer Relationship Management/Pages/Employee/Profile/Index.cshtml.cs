...
namespace Customer_Relationship_Management.Pages.Employee.Profile
{
    public class IndexModel : PageModel
    {
        ...
        // Dùng riêng để hiển thị thông tin Manager đầy đủ (nếu là Employee)
        public User? ManagerInfo => CurrentUser?.Manager;
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            // Include Manager & Role để hiển thị
        ...
        public async Task<IActionResult> OnPostChangePasswordAsync(string OldPassword, string NewPassword, string ConfirmPassword)
        {
            ...
            user.ForceChangePassword = false; // tự đổi -> không bật flag
            user.UpdatedAt = DateTime.UtcNow;
